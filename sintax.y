...
equivalenciaExpression:	SOME identificador {;propsPerClass[propEmAnalise] = string("Object Property");}
					...
					| SOME TYPEINTEGER ABRECOLCHETE RELATIONAL PONTOFLUTUANTE FECHACOLCHETE {erroSemantico = true; yyerror("Erro semântico! É esperado um inteiro depois do operador");}
					| SOME TYPEINTEGER ABRECOLCHETE PONTOFLUTUANTE FECHACOLCHETE {erroSemantico = true; yyerror("Erro semântico! É esperado um operador relacional com um inteiro dentro dos colchetes");}
